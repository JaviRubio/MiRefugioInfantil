...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ejercicio.tipo_respuesta'
        db.add_column(u'administracion_ejercicio', 'tipo_respuesta',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ejercicio.tipo_respuesta'
        db.delete_column(u'administracion_ejercicio', 'tipo_respuesta')
