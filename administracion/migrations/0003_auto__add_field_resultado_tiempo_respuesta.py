...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resultado.tiempo_respuesta'
        db.add_column(u'administracion_resultado', 'tiempo_respuesta',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resultado.tiempo_respuesta'
        db.delete_column(u'administracion_resultado', 'tiempo_respuesta')
